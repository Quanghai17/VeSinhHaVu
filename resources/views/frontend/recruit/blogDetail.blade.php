                    ...
                    <article class="blog-post-wrapper">
                        <div class="blog-banner">
                            <a href="#" class="blog-images">
                                <img style="width: 750px; height: 462x" src="{{ Voyager::image( $blog->image ) }}" alt="">
                            </a>
                            ...
                            <div class="left-blog">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="recent-single-post">
                                        <div class="post-img">
                                            <a href="{{ route('show.detail', $rep->slug) }}">
                                                <img src="{{ Voyager::image( $rep->image ) }}" alt="">
                                            </a>
                                        </div>
                                        <div class="pst-content">
                                            <p><a href="{{ route('show.detail', $rep->slug) }}">{{ $rep->title }}</a></p>
                                        </div>
                                    </div>
                                    <!-- End single post -->
                                    @endforeach
